      ...
      <div className='flex flex-col md:flex-row gap-8 justify-between mt-5'>
        <div className='md:flex md:flex-col md:min-w-[70%] lg:min-w-[75%] p-5 text-xl'>
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            <div className='m-auto text-center'>
              {currentUser?.image ? (
                <Image src={currentUser?.image} width={250} height={250} alt='Foto de perfil' />
              ) : (
                <Image
              ...
              <p
                className='flex text-base underline hover:cursor-pointer'
                onClick={() => avatarModal.onOpen(currentUser!)}
              >
                Editar foto
                <span>
                  <TbPhotoEdit size={20} />
            ...
            <div className='text-xl font-bold lg:col-span-2'>
              <div className='flex justify-between gap-8'>
                ...
                <div
                  ...
                  onClick={() => profileModal.onOpen(currentUser!)}
                >
              ...
              <div className='mt-4 mb-4'>
                ...
                <div className='font-normal text-neutral-600'>
                  {currentUser?.phoneNumber ? (
                    <p className='font-normal'>{currentUser?.phoneNumber}</p>
                  ) : (
                    <p className='text-lg'>
                      Agrega un número para que los huéspedes con reservaciones confirmadas y Home
                      Away puedan ponerse en contacto contigo.
                    </p>
                  )}
                </div>
              </div>
        ...
        <div className='w-3/8 border-[1px] p-5 rounded-lg shadow-sm'>
          <div className='m-5'>
            ...
            <p className='text-2xl font-bold mt-2'>¿Por qué mi información no aparece aquí?</p>
          ...
          <div className='m-5'>
            ...
            <p className='mt-2 text-lg text-neutral-500'>
              No se pueden modificar los datos que Home Away utiliza para verificar tu identidad.
              Aunque puedes modificar tus datos personales y de contacto, podríamos pedirte que
              verifiques tu identidad la próxima vez que hagas una reservación o crees un anuncio.
            </p>
          </div>
        </div>
      </div>
