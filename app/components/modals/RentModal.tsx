...
const RentModal = () => {
  ...
  if (step === STEPS.LOCATION) {
    bodyContent = (
      <div className='flex flex-col gap-8'>
        <Heading title='¿Dónde está ubicada tu propiedad?' subtitle='Selecciona una ubicación' />
  ...
  if (step === STEPS.PRICE) {
    bodyContent = (
      <div className='flex flex-col gap-8'>
        <Heading title='¿Cuánto quieres cobrar por noche?' subtitle='¡Establece un precio justo!' />
        <Input
          id='price'
